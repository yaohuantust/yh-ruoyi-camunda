<template>
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="open" width="1000px" append-to-body>
      ...
      <el-row style="border-top: 1px dashed #ddd">
        <h4>流程图</h4>
        <CamundaViewer v-if="this.open" :xmlStr="this.xmlString"></CamundaViewer>
      </el-row>
...
<script>
  import { listLeave, getLeave, delLeave, addLeave, updateLeave, exportLeave } from "@/api/camunda/leave";
  import ApplyBefore from "@/components/Activiti/ApplyBefore/index";
  import ApplyAfter from "@/components/Activiti/ApplyAfter/index";
  import CamundaViewer from "@/views/camunda/viewer";
  import {getProcessDefinitionBpmn20XmlByKey} from "@/api/camunda/modeler";
  ...
  export default {
    ...
    methods: {
      ...
      handleAdd() {
        this.reset();
        getProcessDefinitionBpmn20XmlByKey("leave_demo").then(response => {
